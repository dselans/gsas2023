...
type Config struct {
	...
	ServiceName   string `envconfig:"SERVICE_NAME" default:"billing-svc"`
	...
	ISBSharedQueueName         string   `envconfig:"ISB_SHARED_QUEUE_NAME" default:"billing-svc_shared"`
