...
import (
	...
	"github.com/dselans/billing-svc/api"
	"github.com/dselans/billing-svc/config"
	"github.com/dselans/billing-svc/deps"
)
...
var (
	...
	debug   = kingpin.Flag("debug", "Enable debug output").Short('d').Envar("BILLING_SVC_DEBUG").Bool()
)
...
func main() {
	...
	// Start hsb publishers (commented out for GSAS2023)
