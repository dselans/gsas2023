...
import (
	...
	"github.com/dselans/welcome-svc/api"
	"github.com/dselans/welcome-svc/config"
	"github.com/dselans/welcome-svc/deps"
)
...
var (
	...
	debug   = kingpin.Flag("debug", "Enable debug output").Short('d').Envar("WELCOME_SVC_DEBUG").Bool()
)
