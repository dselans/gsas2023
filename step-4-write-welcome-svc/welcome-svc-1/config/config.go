...
type Config struct {
	...
	ServiceName   string `envconfig:"SERVICE_NAME" default:"welcome-svc"`

	// Dedicated/broadcast RabbitMQ consumer config (commented out for GSAS2023)
	...
	ISBSharedExchangeDeclare   bool     `envconfig:"ISB_SHARED_EXCHANGE_DECLARE" default:"true"`
	ISBSharedExchangeDurable   bool     `envconfig:"ISB_SHARED_EXCHANGE_DURABLE" default:"true"`
	ISBSharedBindingKeys       []string `envconfig:"ISB_SHARED_ROUTING_KEY" default:"events.#"` // UPDATE THIS
	ISBSharedQueueName         string   `envconfig:"ISB_SHARED_QUEUE_NAME" default:"welcome-svc_shared"`
	...
	// HSB settings (commented out for GSAS2023)
